        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://www.rrce.org/">RajaRajeswari College of Engineering</a>
                </div>
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    ...
                    <hr>
                    <p><span style='color:white'>We are here to Build your Skills and Career with our Driven Passion and Reality.</br>Click Below to Get Our Current Drive
                        Details</p>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>#14, Ramohalli Cross</p>
					<p>Kumbalgodu, Mysore Road, Bangalore-74</p>
					<p>Tel: 080-2843 7124/ 080-6566 6769</p>
					<a href="mailto:rrcekumbalagodu@gmail.com">Contact Us</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy; 2022 RRCE |
                    <p>Developed by
                    <p>Sneha N V | Sneha Aparna</p>
				</div>
