    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
          <img src="images/avatar.png" alt="Profile Photo" class="img-responsive">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li>
                  <a href="../../Homepage/index.php">Home RRCE</a>
                </li>
                <li>
                  <a href="../../Drives/index.php">Homepage</a>
                </li>
                <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to RRCE</h2>
              <hr>
              <p>Work is Magic and it defines you at every aspect of ur life.<a href="preferences.php""
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center">
              ...
              <img src="images/download.jpg" alt="Bicycle" class="img-circle img-thumbnail">
            </div>
              ...
              <div class="templatemo-content-widget orange-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <img class="media-object img-circle" src="images/place.jpg" alt="Sunset">
                    </a>
                  </div>
              ...
              <i class="fa fa-times"></i>
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Brace yourself for the Events that will take ur breath away. Get Started and be a Part of RRCE Family</p>
                  </div>
                </div>
              </div>
            </div>
