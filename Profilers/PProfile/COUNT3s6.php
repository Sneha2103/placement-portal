...
{ 
$Cpu = $_POST['cpu'];
$RESULT = $connect->query("SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND `PU/Dip`>='$Cpu'");
$data = $RESULT->fetch_assoc();
echo "<br><h3>Students Scored Above '$Cpu' in PU/Diploma&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = $connect->query("SELECT * FROM basicdetails WHERE `Approve`='1' AND `PU/Dip`>='$Cpu'");
