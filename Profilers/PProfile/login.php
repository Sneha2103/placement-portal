    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
          <img src="images/avatar1.png" alt="Profile Photo" class="img-responsive">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../../Homepage/index.php">Home RRCE</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <p></p>
              <p>Hello Officer! Have a great day with us! With RRCE Account, you can add drives, send notifications and view the eligibility criteria of students.</p>
