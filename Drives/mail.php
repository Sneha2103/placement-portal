		...
		<div class="container">
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>Rajarajeswari College Of Engineering</h4>
					<p>#14, Ramohalli Cross Kumbalgodu, Mysore Road, Bangalore-74
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: 080-2843 7124/ 080-6566 6769 </p>
						
					<p>	E-mail: <a href="rrcekumbalagodu21@gmail.com">Contact Us</a>
					</p>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="address">
						<p>RRCE
							<span>Ramohalli Cross,Bangalore</span>
						</p>
					</div>
					<div class="phone">
