...
<body>
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">RRCE<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Our Institute is located in  Ramohalli cross, a well known place of learning. Our college is affiliated to Visvesvaraya Technological University, Belgaum (Karnataka), recognized by AICTE, New Delhi, & by Government of Karnataka. Within a short span of 15 years we have made our presence felt strongly in this competitive educational sector and we have many firsts to our credit. Our ISO Certification and NBA Accreditation speak of our commitment to quality systems and education. Our credentials are well appreciated by many industries, engineering institutes, professional bodies, government organizations etc. In the recent past our institute has been rated A Grade . 
						</p>
					</div>
				</div>
				<div class="clearfix"> </div>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of RRCE</h3>
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>What We Offer?</h4>
					<p>The Institute offers bachelors degree courses in 7 disciplines in Engineering viz. Computer Science and Engineering, Information Science Engineering, Electronics and Communication Engineering, Electrical and Electronics Engineering, Civil Engineering, Mechanical Engineering, Artificial Intelligence Engineering and  post graduate courses viz. M.Tech in Computer Science And Engineering , Master of Business Administration (MBA) and Master of Computer Applications (MCA). The Institute has facilities for doctoral research in Computer Science , Electronics and Communication , Management Studies , Mathematics. 
					</p>
				</div>
			...
			<div class="team-info">
				...
				<div class="team-grids">
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						...
						<h6>Dr. A C Shanmugam</h6>
						<p> Chairman</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/dean1.jfif" alt="">
						<h6>Dr. Balakrishna R</h6>
						<p>Dean</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/principal.jfif" alt="">
						<h6>Dr. T Chandrashekar</h6>
						<p> Principal</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>RRCE , #14 Ramohalli Cross,Kumbalagodu,
							<span>Mysore road,Bengaluru-74</span>
						</p>
					</div>
					<div class="phone">
						<p>080-2843 7124/080-6566 6769</p>
					</div>
				</div>
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Rajarajeswari College Of Engineering</h6>
					<h4>
